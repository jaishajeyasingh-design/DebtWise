  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-10 space-y-8 animate-fadeIn">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-6 border-b border-slate-800">
        <div>
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-cyan-500/10 border border-cyan-500/30 text-cyan-300 text-xs font-mono mb-2">
        ...
        <div className="shrink-0 flex items-center gap-3">
          <button
            ...
            className="px-4 py-2.5 rounded-xl bg-slate-900/80 hover:bg-slate-800 border border-slate-700/80 text-slate-300 hover:text-white font-mono text-xs flex items-center gap-2 transition shadow-sm"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-7 space-y-4">
          ...
          <div className="flex items-center justify-between gap-4">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 rounded-xl bg-slate-900/90 border border-slate-700/80 text-white placeholder-slate-500 text-xs font-mono focus:outline-none focus:border-cyan-400 focus:ring-1 focus:ring-cyan-400 transition"
              />
            </div>
              ...
              return (
                <div
                  ...
                  className={`cursor-pointer rounded-2xl p-4 transition-all relative border ${
                    isSelected
                      ? 'bg-gradient-to-b from-slate-900 to-slate-950 border-cyan-400/80 shadow-[0_0_20px_rgba(0,240,255,0.15)] ring-1 ring-cyan-400/40'
          ...
          <div className="p-4 rounded-2xl bg-slate-900/50 border border-slate-800/80 text-xs text-slate-400 space-y-2">
        ...
        <div className="lg:col-span-5 space-y-5">
          ...
          <div className="glass-panel rounded-3xl p-6 sm:p-7 border border-cyan-500/30 bg-gradient-to-b from-slate-950/95 to-slate-900/95 shadow-2xl space-y-6">
            ...
            <div className="space-y-3 pt-2">
              <button
                ...
                className="w-full py-4 px-6 rounded-2xl bg-gradient-to-r from-cyan-500 via-blue-500 to-emerald-500 hover:from-cyan-400 hover:to-emerald-400 text-slate-950 font-black text-sm font-mono flex items-center justify-center gap-3 transition shadow-[0_0_25px_rgba(0,240,255,0.3)] disabled:opacity-60 cursor-pointer"
              >
                {isAnalyzing ? (
                  <>
          ...
          <div className="p-4 rounded-2xl bg-slate-900/40 border border-slate-800/80 text-xs font-mono space-y-2.5">
